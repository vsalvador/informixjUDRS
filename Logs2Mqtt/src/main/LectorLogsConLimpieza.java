...
public class LectorLogsConLimpieza {
    private static final String DIRECTORIO_LOGS = "/tmp";
    private static final String PREFIJO_ARCHIVO = "IfxLogger";
    private static final String SUFIJO_ARCHIVO = ".log";
    private static final String EXTENSION_CONTROL = ".offset";
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            for (File archivo : archivosLog) {
                ...
                long offsetGuardado = cargarOffset(archivo);
        ...
        try (RandomAccessFile raf = new RandomAccessFile(archivo, "r")) {
            ...
            while (true) {
                ...
                if (linea != null) {
                    ...
                    // ==========================================
                    // LÓGICA DE PROCESAMIENTO DE TU LÍNEA AQUÍ
    ...
    private static long cargarOffset(File archivoLog) {
        File archivoControl = obtenerArchivoControl(archivoLog);
        if (!archivoControl.exists()) return 0;
        try {
